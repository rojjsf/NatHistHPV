---
title: "Age, time and the international correlation of cervical cancer (Version 005)"
...
labels_upd <- c(`25-34` = str_c(" 25-34y
        correlation coefficient = ", round(spear$all$`25-34`$estimate, 2), " (p = " , round(spear$all$`25-34`$p.value, 5),
                            ")
      slope = ", upd.coef$`25-34`, " (p = ", upd.p$`25-34`, ")"),
            `35-44` = str_c(" 35-44y
        correlation coefficient = ", round(spear$all$`35-44`$estimate, 2), " (p = " , round(spear$all$`35-44`$p.value, 5), 
                            ")
      slope = ", upd.coef$`35-44`, " (p = ", upd.p$`35-44`, ")"),
            `45-54` = str_c(" 45-54y
        correlation coefficient = ", round(spear$all$`45-54`$estimate, 2), " (p = " , round(spear$all$`45-54`$p.value, 5),
                            ")
      slope = ", upd.coef$`45-54`, " (p = ", upd.p$`45-54`, ")"),
            `55-64` = str_c(" 55-64y 
        correlation coefficient = ", round(spear$all$`55-64`$estimate, 2), " (p = " , round(spear$all$`55-64`$p.value, 5),
                            ")
