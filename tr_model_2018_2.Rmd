---
title: "Age, time and the international correlation of cervical cancer"
...
```{r eval = TRUE, echo = FALSE, out.extra='angle=90', fig.align='center', fig.height=16, fig.width=20, out.width="500px"}
gg_loc
```
...
The primary analysis only included countries with low or unclear screening coverage as screening interferes with the natural history.   
...
\newpage
Using 10 year age groups and screening coverage as continuous variables yielded a very significant (p<0.0001) effect of age on the transition rate and its time trend as well as significant (p<0.05) interaction terms between screening, age and the time trend of the transition rate.     
...
There was no significant effect of screening on the time trend of the transition rate when we used 5-year age groups as covariates.   
...
# 3. Conclusion  
In conclusion we could confirm the strong international correlation of hr-HPV prevalence and cervical cancer incidence.  
Secondly we could observe a significant effect of time since hr-HPV detection, age at hr-HPV detection and high screening coverage on the transition rate from hr-HPV to cervical cancer estimated in this ecological study. The transition rate stabilizes in higher age groups and earlier in countries with high screening coverage. 