...
ggplot2::ggplot(DpC, aes(x = YsncS, y = Nicc*100000/Npos)) + 
...
#ln(Nicc/Npos) = tr*YsncS
#exp(tr*YsncS) = Nicc/Npos
# -> exponential Poisson rate model

tr <- glm(Nicc *100000/Npos ~ YsncS + Location, family = poisson, data = DpC, weights = Npos) 
summary(tr)
ci.exp(tr)
