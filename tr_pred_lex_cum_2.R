...
## `---
##`title: "Prediction of cumulative incidence risks using Lexis with IR for all women and tr.rate for HPV pos. Other Registries for smoother fit"
##`author: "RSF"
...
####`1. info table ####
# iran rmvd
# poland: all same (ex silesia) or krakow and poznan as bigger cities
# colombia: cali and bucamaranga(hpv) or all cali?
# girona not run
...
orig <- info$sgcentre[info$Location != "Costa Rica" & info$Location != "Colombia"]
